...
Current HEAD: `ab0f590d2ccde39a785837c0db6d44422ac698e8` on `portal/full-fidelity-p1`. The working tree contains only the scoped STEP 1A source, test, setup-script and portal-document changes. Preserve the earlier portal, map, material, traversal and presentation work; do not reset or restore the retained Legacy UI.
