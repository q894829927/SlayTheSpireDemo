...
Changed source/test/design files include:
...
The P1 runtime fix invalidated only the Editor Build and the focused R8 Automation
gate. The user reran both on **2026-09-01** and confirmed:
