...
The confirmation handoff also preserves the selected formal Hand widget's render
translation and visibility. A committed Hand→Exhaust record therefore reuses the
existing generic Exhaust opacity fade on that same widget at its confirmed
selection position; it is not reset to the Hand layout and no second consume
