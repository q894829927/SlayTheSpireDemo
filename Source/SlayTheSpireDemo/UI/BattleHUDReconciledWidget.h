 ...
 * children retain RuntimeId identity within one Battle, and transient card
 * ownership changes are consumed independently of historical snapshot
 * publication. This layer is intentionally Selection-agnostic.
 */
